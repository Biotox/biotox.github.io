document.addEventListener('DOMContentLoaded', function () {
    ...
    const liveButton = document.getElementById('liveButton'); // Adding the LIVE button
    ...
    function togglePlayPause() {
        ...
        showCenterPlayPause(); // Show button when toggling play/pause
    }
    ...
    function goToLive() {
        // Seek video to the beginning and start playback
